...
#include <memory>
#include "../Manager_for_home_web_server/prompt.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Prompt_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Prompt_t qt_meta_stringdata_Prompt = {
    {
QT_MOC_LITERAL(0, 0, 6), // "Prompt"
...
QT_MOC_LITERAL(4, 46, 6) // "button"
    ...
    "Prompt\0on_buttonBox_clicked\0\0"
...
QT_INIT_METAOBJECT const QMetaObject Prompt::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Prompt.data,
    qt_meta_data_Prompt,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Prompt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Prompt.stringdata0))
